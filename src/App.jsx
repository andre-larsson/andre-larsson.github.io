    ...
    <main className="page">
      ...
      <section className="links">
        ...
        <div className="link-item">
          ...
          <span>Ear training for intervals in your browser.</span>
        </div>
        <div className="link-item">
          <a href="https://andre-larsson.github.io/quiz-system/">Quiz System</a>
          <span>Modular quiz engine with JSON-based question files.</span>
        </div>
        <div className="link-item">
          <a href="https://andre-larsson.github.io/musicians-toolbox/">Musicians Toolbox</a>
          <span>Browser metronome, tap tempo, tuner, and speaker check.</span>
        </div>
        <div className="link-item">
          <a href="https://andre-larsson.github.io/json-object-arrayifier/">JSON Object Arrayifier</a>
          <span>Convert whitespace-separated JSON objects into a valid array.</span>
        </div>
      </section>
    </main>
  )
